...
Собрано и обкатано 2026-07-12 на RTX 5090 + дисплей 4K@144. Для справки: внутри
madVR Envy Extreme MK2 стоит RTX 4080, и интерполяции кадров у Envy нет вообще.
...
| `8` | **8K-профиль** | Нейро-2x до 7680x4320 для 4K-исходников, без уплавнялки (вместе с RIFE в бюджет 5090 не влезает) |
